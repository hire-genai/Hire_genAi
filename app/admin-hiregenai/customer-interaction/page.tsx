      ...
      <div className="space-y-2">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl">
          <div className="pt-2 px-4 pb-4">
            {/* Tabs and Search Header Skeleton */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
              <div className="flex gap-2 bg-slate-800 border border-slate-700 p-1 rounded-lg">
                <div className="h-7 w-32 bg-slate-700 animate-pulse rounded-md" />
                <div className="h-7 w-28 bg-slate-700 animate-pulse rounded-md" />
                <div className="h-7 w-24 bg-slate-700 animate-pulse rounded-md" />
              </div>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 bg-slate-700 animate-pulse rounded" />
                <div className="pl-9 h-9 w-64 bg-slate-700 animate-pulse rounded-lg" />
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-6 pb-4 border-b border-slate-700">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="h-8 w-20 bg-slate-700 animate-pulse rounded-full" />
              ))}
            </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="h-8 w-8 bg-slate-700 animate-pulse rounded-full" />
                        <div>
                          <div className="h-5 w-32 bg-slate-700 animate-pulse rounded mb-1" />
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="h-3 w-28 bg-slate-700 animate-pulse rounded" />
                      </div>
                    </div>
