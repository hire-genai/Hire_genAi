...
export default function DateRangeFilter({
  ...
  const handleApply = () => {
    ...
    if (filterType === "preset") {
      ...
      else filterLabel = `Last ${days} days`
    } else {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Select date range and other filters</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <Select
                value={filterType}
                onValueChange={(val: "preset" | "custom") => setFilterType(val)}
              >
