...
- Name: 05-job-posting.spec.ts >> Job Posting — Negative Scenarios >> 1. Create job without required fields shows validation
- Location: tests\e2e\05-job-posting.spec.ts:847:7
