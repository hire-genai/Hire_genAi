...
- Name: 03-pricing-subscription.spec.ts >> Pricing — Subscription Purchase Negative Scenarios >> 1. Stripe payment failure shows error message on pricing page
- Location: tests\e2e\03-pricing-subscription.spec.ts:660:7
