...
- Name: 12-apply-all-jobs.spec.ts >> Apply → Senior Software Engineer (E2E Test) >> 6. Candidate stored in DB after submission
- Location: tests\e2e\12-apply-all-jobs.spec.ts:172:9
